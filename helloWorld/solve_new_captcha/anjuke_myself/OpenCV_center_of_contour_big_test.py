...
opencv入门——寻找图中的相似图案
https://jingyan.baidu.com/article/d2b1d102dda4795c7f37d47f.html
...
file_name =r"C:\Users\Administrator\Downloads\captcha_img.jpg"
...
# step3：对模糊图像二值化。梯度图像中不大于51的任何像素都设置为0（黑色）。 否则，像素设置为255（白色）。
